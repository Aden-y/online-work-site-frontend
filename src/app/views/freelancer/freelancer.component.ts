...
export class FreelancerComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'budget', 'topic', 'price', 'deadline', 'freelancer_id'];
  ...
  ngOnInit() {
    this.loadMe();
    this.jobService.getFreelancerJobsInProgress().subscribe(data => this.dataSource.data = data);
